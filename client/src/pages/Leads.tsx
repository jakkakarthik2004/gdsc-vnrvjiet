  ...
  const testimonials = [
    {
      ...
      description: `" As the lead of the Google Developer Chapter, I want to emphasize the outstanding contributions of our community. Our chapter consistently exemplifies a commitment to innovation, knowledge sharing, and fostering a vibrant ecosystem of developers. The dedication, passion, and expertise of our members have not only enriched the skills of individuals but have also contributed significantly to the advancement of the tech industry. It's an honor to be part of a community that continues to drive progress, inspire creativity, and shape the future of technology.."`,
    },
    {
      image: colead,
      title: "Rishab (Co-Lead)",
      description: `"As the GDSC founder, I'm delighted to share my heartfelt testimonial for this remarkable community.
    ...
    },
    {
      ...
      description: `"GDSC is a great entity to be in where learning developmentismeant to be fun. GDSC is a place where creativity about software development converges. This has helped me learn a lot while collaboratively organizing events such as hackathons and workshops. Although this is the first year for GDSC-VNRVJIET, wehad always had unique approaches and colaborations to come up with. I am grateful for the opportunity to bepart of GDSC"`,
    },
    {
      image: weblead,
